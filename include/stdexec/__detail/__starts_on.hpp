...
namespace STDEXEC
{
  ...
  struct starts_on_t
  {
    ...
    using __sndr_t = __sexpr_t<starts_on_t, __decay_t<_Scheduler>, __decay_t<_Sender>>;

    template <scheduler _Scheduler, sender _Sender>
    constexpr auto
    operator()(_Scheduler&& __sched, _Sender&& __sndr) const -> __sndr_t<_Scheduler, _Sender>
    {
      STDEXEC::__ensure_well_formed_sender<__sndr_t<_Scheduler, _Sender>>();
